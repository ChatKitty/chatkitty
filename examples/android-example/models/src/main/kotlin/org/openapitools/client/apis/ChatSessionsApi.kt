...
class ChatSessionsApi(basePath: kotlin.String = defaultBasePath, client: OkHttpClient = ApiClient.defaultClient) : ApiClient(basePath, client) {
    ...
    fun listChatSessions(page: kotlin.Int? = 0, size: kotlin.Int? = 25, sort: kotlin.collections.List<kotlin.String>? = null, state: StateListChatSessions? = null) : PagedModelChatSessionResource {
     ...
     * @param sort Sorting criteria in the format: property,(asc|desc). Default sort order is ascending. Multiple sort criteria are supported. (optional)
     * @param state Filters by state (optional)
     * @return ApiResponse<PagedModelChatSessionResource?>
     * @throws IllegalStateException If the request is not correctly configured
     * @throws IOException Rethrows the OkHttp execute method exception
     */
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class)
    fun listChatSessionsWithHttpInfo(page: kotlin.Int?, size: kotlin.Int?, sort: kotlin.collections.List<kotlin.String>?, state: StateListChatSessions?) : ApiResponse<PagedModelChatSessionResource?> {
        val localVariableConfig = listChatSessionsRequestConfig(page = page, size = size, sort = sort, state = state)

        return request<Unit, PagedModelChatSessionResource>(
            localVariableConfig
        )
    }
     ...
     */
    fun listChatSessionsRequestConfig(page: kotlin.Int?, size: kotlin.Int?, sort: kotlin.collections.List<kotlin.String>?, state: StateListChatSessions?) : RequestConfig<Unit> {
