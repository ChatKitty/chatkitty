...
import org.openapitools.client.models.PagedModelChatSessionResourceEmbedded
...
data class PagedModelChatSessionResource (

    @Json(name = "_embedded")
    val embedded: PagedModelChatSessionResourceEmbedded? = null,
